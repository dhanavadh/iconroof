...
export const metadata: Metadata = {
  ...
  title: 'Amigo ระแนงบังตา – จำหน่ายอุปกรณ์ระแนงไวนิล | ไม้ระแนงเฌอร่า-ระแนงไม้เทียม – Iconroof',
