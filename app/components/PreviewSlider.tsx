      ...
      >
        ...
        <SwiperSlide>
            <div className='slider-core'>             
                <img src='/asset/roof-1.jpg' className='hidden lg:flex absolute z-[-1] w-full h-full object-cover brightness-50' alt='AmigoRoof'></img>
                <img src='/asset/roof-1.jpg' className='flex lg:hidden absolute z-[-1] w-full h-full object-cover brightness-50' alt='AmigoRoof'></img>
                <div className='text-area-padding'>
                    <p className='title-section'>ยูเทียมพระเงิน 2</p>
